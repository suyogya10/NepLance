        ...
        <div className="row d-flex gap-5" style={{ justifyContent: "center" }}>
          ...
          >
            ...
            <MDBCardBody>
              ...
              <MDBCardText>
                ...
                and ratings. Pay the freelancer after the work is done via
                Khalti. You can also chat with the freelancers.
              </MDBCardText>
            </MDBCardBody>
          </MDBCard>
          <MDBCard
          ...
          >
            ...
            <MDBCardBody>
              ...
              <MDBCardText>
                As a freelancer you can create your profile and add your
                services. You can see the list of orders from clients who have
                purchased your service and deliver the results to them. You can
                also see the reviews and ratings given by the clients. You will
                also have all the abilities of a client.
              </MDBCardText>
            </MDBCardBody>
          </MDBCard>
        </div>
