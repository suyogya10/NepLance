...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2023 at 02:50 PM
...
(18, 'You have a new order from Kishor Chandra Gautam', 29),
(19, 'Your order from Gaurav Thapaliya has been delivered', 107),
(20, 'Your latest request has a new bid by Gaurav Thapaliya', 107),
(21, 'Your bid has been accepted Kishor Chandra Gautam', 29),
(22, 'You have a new message from Kishor Chandra Gautam', 29),
(23, 'You have a new message from Gaurav Thapaliya', 107),
(24, 'You have a new message from Gaurav Thapaliya', 107),
(25, 'You have a new message from Kishor Chandra Gautam', 29),
(26, 'One of your requests has been delivered by Gaurav Thapaliya', 107);
...
(12, 'I will create a logo for you', 'product/Ql4OaaHz4n4KsEcBtpfeh6p2wz4R0aOjhiDqXVS1.jpg', 'I will create high class logo for affordable price.', '6,000', '2023-05-18', '2023-03-03', 'design-editing', 27),
...
(68, 'I will be your react js javascript developer for web app in reactjs', 'product/sNECrhYSygWPEXen68rCBd5t8u3zCRCzCSxKnLg5.webp', 'I will fix one or two small bugs in react gatsby or nextjs application', '2000', '2023-05-07', '2023-05-07', 'computer-it', 35);
...
(27, 'Suyogya Gautam', 'suyogya', NULL, '$2y$10$fa7VSYwaCVvhrt5q0txoCeUetxFsDXWzNq3WnusuYuIe6k1ZyM8vu', NULL, 'NepLance User', 'users/XAbNhkAyjj9Pbay2GT8JzAwnyDkAEifQkYkyNNxh.jpg', '9840856344', 'yes', '', 'I am a student at Herald College, Kathmandu studying Bachelors (Hons.) in Computer Science. I am studying Python, Java and mySQL at college. I have good knowledge and skill on MS Word, PowerPoint and Excel. I can also work on Adobe Photoshop, Premier Pro and After Effects.', 'users/Ze43FhpMjTqLvNNgEVAyLHMFyhNHT6gaLMRlwzRj.png', 'yes', NULL, 'seller', 'gsuyogya@gmail.com', 'users/9rmGp4sUIySFmR9txXOoCUQPeWlZYO6aeYtQhVMj.pdf', 'writing', '2020-01-04', 'Bsc. Hons. Computer Science', '2023-06-01', 'users/Acoo1ikNmTJtCcQwzp7Iwpz9VKZE1jRHDKbYh9CO.png', 'no', 'medical-health,writing', '1'),
...
(29, 'Gaurav Thapaliya', 'gaurav', NULL, '$2y$10$Mddd5Expa87akP.j4QfYa.3oSyBFC/ORNCarHtTlPb6HC4qvd3A4a', NULL, 'All Round Freelancer', 'users/hello.jpg', '0', 'yes', '0', 'This is my bio. Reach me at \"gauravthapaliaya10@gmail.com\"', '', 'no', NULL, 'seller', NULL, NULL, 'writing', NULL, NULL, NULL, NULL, 'no', 'writing', '1'),
(32, 'Raymon', 'raymon', NULL, '$2y$10$2KeaC14wSl/Ws51nRgPuM.ztvPvwwz9Ndw4CydPx/t/XUOL66mjFC', NULL, 'Full Stack Developer', 'users/9FA3uPP1G3XWG8wnqFBpLnK1ILR1J1dU3ydJIC0t.png', '0', 'yes', '0', 'No Bio lol', '', 'no', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'no', 'writing,design-editing', '1'),
...
(34, 'Sabin Adhikari', 'sabin', NULL, '$2y$10$5Tjk6sInJEe2nOQXfJPEV.ldxlygdvncuCVAs7/Cxwwu7c5Xyvqvi', NULL, 'Unity Developer', 'users/hello.jpg', '', 'yes', '', NULL, '', 'no', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'no', 'administrative', '1'),
...
(103, 'Yogesh Kharel', 'yogesh10', NULL, '$2y$10$AT9.pnmqgMFjhQEeptvW7u5.cbysnjnfZm/Gfis4DRmGtME.KC7eO', NULL, NULL, 'users/hello.jpg', '1234567890', 'yes', '', NULL, NULL, 'no', NULL, 'client', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'no', 'writing', '1'),
(104, 'Ajay Ojha', 'ajay10', NULL, '$2y$10$p4OIXxdOoMuopad4Q.nMnuOUSfW6EGiEfrtF/YNkqzR9BBR62ZT02', NULL, '⚽', 'users/dHMUegzrvOmjq5c6nTlkNGReujoW4WurZpiOo4Ci.jpg', '1234567890', 'yes', '', 'Student BBA', NULL, 'no', NULL, 'client', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'no', 'design-editing,writing,computer-it', '1');
...
--
ALTER TABLE `products`
  MODIFY `id` int(120) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
